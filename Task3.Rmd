...
where $y_i$ is the original response variable and $p_i$ is defined as below, which comes from the logistic function of conditional distribution of the response variable $y$:
...
# finally we got beta_0 and beta_1
print(beta_0)
print(beta_1)
```