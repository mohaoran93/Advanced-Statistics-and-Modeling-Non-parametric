...
From the plot we can see that for both values of bandwith the p-value is greater than 0.05, therefore, we cannot reject the null hypothesis of linearity.
